...
void dodajOsobe(int* nrIndeksu, string* imie, string* nazwisko, bool* obecny, int* liczbaOsob, int nrIndeksuVal, const string* imieVal, const string* nazwiskoVal, bool obecnyVal)
{
    if(*liczbaOsob < MAX)
    {
...
void ustawObecnosc(int* nrIndeksu, bool* obecny, int* liczbaOsob, int nrIndeksuVal, bool obecnosci)
{
...
bool edytujOsobe(int* nrIndeksu, string* imie, string* nazwisko, bool* obecny, int* liczbaOsob, int nrIndeksuVal, int nowyNrIndeksu, const string* noweImie, const string* noweNazwisko, bool zmienicObecnosc, bool nowaObecnosc)
{
    int idx = -1;
    for(int i = 0; i < *liczbaOsob; i++)
    {
...
bool usunOsobe(int* nrIndeksu, string* imie, string* nazwisko, bool* obecny, int* liczbaOsob, int nrIndeksuVal)
{
    int idx = -1;
    for(int i = 0; i < *liczbaOsob; i++)
    {
...
void drukujListe(int* nrIndeksu, string* imie, string* nazwisko, bool* obecny, int* liczbaOsob)
{
    cout << "\nLista obecnosci:\n";
...
{
    int liczbaOsob = 0;
    int nrIndeksuTab[MAX];
    string imieTab[MAX];
    string nazwiskoTab[MAX];
    bool obecnyTab[MAX];
    ...
    do
    {
        ...
        switch(wybor)
        {
            case '1':
            {
                ...
                for(int i = 0; i < liczbaOsob; i++)
                {
                    if(nrIndeksuTab[i] == nrIndeksuVal)
                    {
                        existsIndex = true;
                        break;
                    }
                ...
                dodajOsobe(nrIndeksuTab, imieTab, nazwiskoTab, obecnyTab, &liczbaOsob, nrIndeksuVal, &imieVal, &nazwiskoVal, obecnyVal);
                break;
            }
            case '2':
            {
                ...
                bool ok = edytujOsobe(nrIndeksuTab, imieTab, nazwiskoTab, obecnyTab, &liczbaOsob, nrIndeksuVal, nowyNrIndeksu, &noweImie, &noweNazwisko, zmienicObecnosc, nowaObecnosc);
                if(!ok)
                {
            ...
            case '3':
            {
                ...
                cin >> nrIndeksuVal;
                bool ok = usunOsobe(nrIndeksuTab, imieTab, nazwiskoTab, obecnyTab, &liczbaOsob, nrIndeksuVal);
                if(!ok)
                {
            ...
            case '4':
                drukujListe(nrIndeksuTab, imieTab, nazwiskoTab, obecnyTab, &liczbaOsob);
                break;
            case '5':
                cout << "Koniec.\n";
                break;
